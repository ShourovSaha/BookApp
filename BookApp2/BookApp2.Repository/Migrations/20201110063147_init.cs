    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("578837f7-2dea-4222-ad13-71ce33eb21b6"), "CSE" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "CatalogueId", "Genre", "Price", "Publisher", "Title" },
                values: new object[] { 1, "Joe", new Guid("578837f7-2dea-4222-ad13-71ce33eb21b6"), "Programmoig", 200, "Aprex", "C# Learing" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "CatalogueId", "Genre", "Price", "Publisher", "Title" },
                values: new object[] { 2, "Alex", new Guid("578837f7-2dea-4222-ad13-71ce33eb21b6"), "Database", 220, "Oracle Publication", "PL/SQL Learing" });
